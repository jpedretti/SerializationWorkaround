...
namespace SerializationWorkaround
{
    ...
    ///</summary>
    [DataContract]
    public static class SerializablePropertySupport
    {
        ...
        internal static string ExtractPropertyNameFromLambda(LambdaExpression expression)
        {
            ...
            if (property == null)
                throw new ArgumentException("Expression Not A Property", nameof(expression));

            var getMethod = property.GetMethod;
            if (getMethod.IsStatic)
                throw new ArgumentException("Expressionn Cannot Be Static", nameof(expression));
